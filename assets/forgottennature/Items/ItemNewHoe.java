...
public class ItemNewHoe extends ItemHoe {
   ...
   public ItemNewHoe(int par1, EnumToolMaterial par2EnumToolMaterial) {
      ...
      this.ID = par1;
      if(this.ID == forgottennature.crystalToolIndex - 252) {
         LanguageRegistry.addName(new ItemStack(this), "Light Crystal Hoe");
      } else if(this.ID == forgottennature.crystalToolIndex - 249) {
         LanguageRegistry.addName(new ItemStack(this), "Dark Crystal Hoe");
      } else if(this.ID == forgottennature.newToolIndex - 254) {
   ...
   public String getUnlocalizedName(ItemStack i) {
      return this.ID == forgottennature.crystalToolIndex - 252?"choe":(this.ID == forgottennature.crystalToolIndex - 249?"dhoe":"ohoe");
   }
}

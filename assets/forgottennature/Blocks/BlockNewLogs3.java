...
public class BlockNewLogs3 extends Block {
   ...
   public Icon getIcon(int i, int j) {
      return (i != 1 && i != 0 || j >= 5) && (i != 5 && i != 4 || j <= 4 || j >= 10)?((i == 3 || i == 2) && j > 9?this.field_94349_a[0]:(j != 0 && j != 5 && j != 10?(j != 1 && j != 6 && j != 11?(j != 2 && j != 7 && j != 12?(j != 3 && j != 8 && j != 13?this.field_94349_a[5]:this.field_94349_a[4]):this.field_94349_a[3]):this.field_94349_a[2]):this.field_94349_a[1])):this.field_94349_a[0];
   }
               ...
               if(!var27.booleanValue()) {
                  for(i3 = 0; i3 < var28.length; ++i3) {
                     ...
                     if(var28[i3][1] > 0 && var28[i3][1] < forgottennature.lumberjackPower && world.getBlockId(var28[i3][0], var28[i3][1], var28[i3][2]) == super.blockID) {
                        if(met > 9) {
                           this.dropBlockAsItem_do(world, i, j, k, new ItemStack(Block.blocksList[super.blockID], 1, met - 10));
                        } else if(met > 5) {
                           this.dropBlockAsItem_do(world, i, j, k, new ItemStack(Block.blocksList[super.blockID], 1, met - 5));
                        } else {

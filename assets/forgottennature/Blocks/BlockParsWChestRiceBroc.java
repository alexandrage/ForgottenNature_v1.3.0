...
public class BlockParsWChestRiceBroc extends BlockFlower {
   ...
   public BlockParsWChestRiceBroc(int par1) {
      super(par1);
   ...
   public void registerIcons(IconRegister par1IconRegister) {
      ...
      for(int i = 0; i < this.field_94349_a.length; ++i) {
         if(i < 4) {
            this.field_94349_a[i] = par1IconRegister.registerIcon("forgottennature:Parsley_" + i);
         } else if(i > 3 && i < 8) {
            this.field_94349_a[i] = par1IconRegister.registerIcon("forgottennature:Broccoli_" + (i - 4));
         } else if(i > 7 && i < 12) {
            this.field_94349_a[i] = par1IconRegister.registerIcon("forgottennature:WaterChestnut_" + (i - 8));
         } else if(i > 11) {
            this.field_94349_a[i] = par1IconRegister.registerIcon("forgottennature:Rice_" + (i - 12));
         }
      }

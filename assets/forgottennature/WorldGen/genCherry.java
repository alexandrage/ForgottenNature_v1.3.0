...
public class genCherry extends WorldGenerator {
   ...
   public genCherry(int i, int j, int k, int l) {
      this.leafID = i;
      this.leafMeta = j;
      this.logID = k;
      this.logMeta = l;
      if(this.leafID == forgottennature.leafIDindex + 1 && this.leafMeta == 1 && this.rand.nextInt(10) == 0) {
         this.leafMeta = 2;
      }
      ...
      for(var11[par5] = var10[par5]; var12 <= var7; ++var12) {
         ...
         while(var13 <= var7) {
            ...
            if(var15 > (double)(par4 * par4)) {
               ...
               if(var14 != 0 && var14 != this.leafID) {
                  ++var13;
               } else {
                  this.setBlockAndMetadata(this.worldObj, var11[0], var11[1], var11[2], this.leafID, this.leafMeta);
                  ++var13;
               }
            }
         }
   ...
   void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger) {
      ...
      if(var4[var6] != 0) {
         ...
         for(int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
            ...
            Math.max(var18, var19);
            this.setBlockAndMetadata(this.worldObj, var14[0], var14[1], var14[2], this.logID, this.logMeta);
         }
      }

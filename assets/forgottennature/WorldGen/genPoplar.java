                  ...
                  if(var17 == 2 && jn > 2) {
                     for(x = -2; x <= 2; ++x) {
                        for(y = -2; y <= 2; ++y) {
                           ...
                           if((Math.abs(x) != 2 || Math.abs(y) != 2) && (Math.abs(x) != 2 || Math.abs(y) != 1) && (Math.abs(x) != 1 || Math.abs(y) != 2) && jn <= 6 * var17 - 1 && jn > 3 && world.getBlockId(i1 + x, j1 + jn, k1 + y) == 0) {
                              world.setBlock(i1 + x, j1 + jn, k1 + y, this.leaf, this.leafmeta, 2);
                           }
                        }
                     }
                  ...
                  if(var17 == 3 & jn > 2) {
                     for(x = -2; x <= 2; ++x) {
                        for(y = -2; y <= 2; ++y) {
                           ...
                           if((Math.abs(x) != 2 || Math.abs(y) != 2) && (Math.abs(x) != 2 || Math.abs(y) != 1) && (Math.abs(x) != 1 || Math.abs(y) != 2) && jn <= 6 * var17 && jn > 3 && world.getBlockId(i1 + x, j1 + jn, k1 + y) == 0) {
                              world.setBlock(i1 + x, j1 + jn, k1 + y, this.leaf, this.leafmeta, 2);
                           }
                        }
                     }
                  ...
                  if(var17 == 4 & jn > 2) {
                     for(x = -3; x <= 3; ++x) {
                        for(y = -3; y <= 3; ++y) {
                           ...
                           if(Math.abs(x) <= 2 && Math.abs(y) <= 2 && (Math.abs(x) != 2 || Math.abs(y) != 2) && jn == 6 * var17 | jn == 5 && world.getBlockId(i1 + x, j1 + jn, k1 + y) == 0) {
                              world.setBlock(i1 + x, j1 + jn, k1 + y, this.leaf, this.leafmeta, 2);
                           }

                           if((Math.abs(x) != 3 || Math.abs(y) != 3) && (Math.abs(x) != 3 || Math.abs(y) != 2) && (Math.abs(x) != 2 || Math.abs(y) != 3) && jn <= 6 * var17 - 1 && jn > 5 && world.getBlockId(i1 + x, j1 + jn, k1 + y) == 0) {
                              world.setBlock(i1 + x, j1 + jn, k1 + y, this.leaf, this.leafmeta, 2);
                           }
                        }
                     }
